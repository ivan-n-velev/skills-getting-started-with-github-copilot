...
activities = {
    "Basketball Team": {
        "description": "Team practices, skill drills, and inter-school basketball matches",
    ...
    "Science Club": {
        "description": "Hands-on experiments and collaborative STEM projects",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Ensure the participant is currently registered
